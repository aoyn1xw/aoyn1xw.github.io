...
function initCommissionStatusLabel() {
    const meta = COMMISSION_STATUS_META[COMMISSION_STATUS];
    if (!meta) {
        return;
    }
    ...
    card.innerHTML = `
        ...
        <div class="project-meta">
            <span class="project-tag">
                ...
                <span class="visually-hidden">Language: </span>${language}
            </span>
            <div class="project-stats">
                <span class="stat">
                    ...
                    <span class="visually-hidden">Stars: </span>${repo.stargazers_count}
                </span>
                <span class="stat">
                    ...
                    <span class="visually-hidden">Forks: </span>${repo.forks_count}
                </span>
                <span class="stat">
                    <svg class="stat-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    ...
                    <span class="visually-hidden">Open issues: </span>${repo.open_issues_count}
                </span>
                <span class="stat">
                    <svg class="stat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                    ...
                    <span class="visually-hidden">Contributors: </span>${repo.contributors}
                </span>
            </div>
        </div>
        <div class="project-actions">
            <a href="${repoUrl}" target="_blank" rel="noopener noreferrer" class="project-btn">
            ...
            ${hasDemo ? `
                <a href="${escapeHtml(repo.homepage)}" target="_blank" rel="noopener noreferrer" class="project-btn">
